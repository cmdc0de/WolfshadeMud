...
CHalfOrcReference::~CHalfOrcReference() {
  //do nothing
}

CHalfOrcReference::CHalfOrcReference() : CRacialReference() {
  SetAll();
  m_nSize = SIZE_MEDIUM;
...
void CHalfOrcReference::SetCharisma() {
...
void CHalfOrcReference::SetIntellegence() {
...
void CHalfOrcReference::SetWisdom() {
...
void CHalfOrcReference::SetPower() {
...
void CHalfOrcReference::SetConstitution() {
...
void CHalfOrcReference::SetInnateRace() {
  m_sInnateRace.m_nInnate_ablities = INNATE_ULTRAVISION |
	  INNATE_DAY_SIGHT | INNATE_INFRAVISION;
...
void CHalfOrcReference::SetStrength() {
...
void CHalfOrcReference::SetDexterity() {
...
void CHalfOrcReference::SetAgility() {
