...
CKenderReference::~CKenderReference() {
   //do nothing
}

CKenderReference::CKenderReference() : CRacialReference() {
   SetAll();
   m_nSize = SIZE_SMALL;
...
void CKenderReference::SetCharisma() {
...
void CKenderReference::SetIntellegence() {
...
void CKenderReference::SetWisdom() {
...
void CKenderReference::SetPower() {
...
void CKenderReference::SetConstitution() {
...
void CKenderReference::SetInnateRace() {
...
void CKenderReference::SetStrength() {
   ...
   m_sStrength[11] = sStrength(5, 230, 30); //110-119
   m_sStrength[12] = sStrength(6, 270, 35); //120
}

void CKenderReference::SetDexterity() {
...
void CKenderReference::SetAgility() {
