...
CNPCPaladin::CNPCPaladin(CMobPrototype &mob, CRoom *pPutInRoom)
	:CPaladin(mob,pPutInRoom),CNPC(mob,pPutInRoom),CCharacter(mob,pPutInRoom)
{
...
////////////////////////////
short CNPCPaladin::GetMaxHitPointsPerLevel()
{
