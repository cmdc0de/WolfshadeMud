...
CKenkuReference::~CKenkuReference() {
   //do nothing
}

CKenkuReference::CKenkuReference() : CRacialReference() {
   SetAll();
   m_nSize = SIZE_MEDIUM;
...
void CKenkuReference::SetCharisma() {
...
void CKenkuReference::SetIntellegence() {
...
void CKenkuReference::SetWisdom() {
...
void CKenkuReference::SetConstitution() {
...
void CKenkuReference::SetInnateRace() {
   m_sInnateRace.m_nInnate_ablities = INNATE_INFRAVISION |
	   INNATE_DAY_SIGHT | INNATE_FLY;
...
void CKenkuReference::SetAgility() {
