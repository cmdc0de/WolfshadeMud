...
CNoneReference::~CNoneReference()
{
	//do nothing
}

CNoneReference::CNoneReference() : CRacialReference()
{
	SetAll();
	m_nSize = SIZE_MEDIUM;
...
void CNoneReference::SetCharisma()
{
...
void CNoneReference::SetIntellegence()
{
...
void CNoneReference::SetConstitution()
{
...
void CNoneReference::SetInnateRace()
{
	...
	m_sInnateRace.m_nRaceWar = RACE_NO_HASSLE;
...
void CNoneReference::SetStrength()
{
	m_sStrength[0] = sStrength(0,100,-10); //0-9
	m_sStrength[1] = sStrength(0,100,0); //10-19
	m_sStrength[2] = sStrength(0,100,0); //20-29
	m_sStrength[3] = sStrength(1,100,0); //30-39
	m_sStrength[4] = sStrength(1,100,0); //40-49
	m_sStrength[5] = sStrength(1,100,0); //50-59
	m_sStrength[6] = sStrength(1,100,0); //60-69
	m_sStrength[7] = sStrength(2,100,0); //70-79
	m_sStrength[8] = sStrength(3,105,10); //80-89
	m_sStrength[9] = sStrength(4,200,20); //90-99
	m_sStrength[10] = sStrength(5,300,30); //90-99
	m_sStrength[11] = sStrength(5,300,30); //110-119
	m_sStrength[12] = sStrength(6,350,35); //120
}

void CNoneReference::SetDexterity()
{
...
void CNoneReference::SetAgility()
{
