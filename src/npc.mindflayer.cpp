...
CNPCMindflayer::CNPCMindflayer(CMobPrototype &mob,CRoom *pPutInRoom)
	:CMindflayer(mob,pPutInRoom), CNPC(mob,pPutInRoom),CCharacter(mob,pPutInRoom)
{
...
////////////////////////////
short CNPCMindflayer::GetMaxHitPointsPerLevel()
{
