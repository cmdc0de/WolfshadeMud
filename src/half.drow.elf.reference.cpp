...
CHalfDrowElfReference::~CHalfDrowElfReference()
{
	//do nothing
}

CHalfDrowElfReference::CHalfDrowElfReference() : CRacialReference()
{
	SetAll();
	m_nSize = SIZE_MEDIUM;
...
void CHalfDrowElfReference::SetCharisma()
{
...
void CHalfDrowElfReference::SetIntellegence()
{
	...
	m_sIntellegence[11] = sIntellegence(20,-3,2); //110-119
	m_sIntellegence[12] = sIntellegence(30,-4,3); //120
}

void CHalfDrowElfReference::SetWisdom()
{
...
void CHalfDrowElfReference::SetPower()
{
...
void CHalfDrowElfReference::SetConstitution()
{
	...
	m_sConstitution[7] = sConstitution(1,2,0); //70-79
	m_sConstitution[8] = sConstitution(2,3,0); //80-89
	m_sConstitution[9] = sConstitution(4,4,10); //90-99
	m_sConstitution[10] = sConstitution(5,5,20); //100-109
	m_sConstitution[11] = sConstitution(6,6,30); //110-119
	m_sConstitution[12] = sConstitution(7,7,40); //120
}

void CHalfDrowElfReference::SetInnateRace()
{
	m_sInnateRace.m_nInnate_ablities = INNATE_ULTRAVISION |
		INNATE_DAY_SIGHT;
	m_sInnateRace.m_nMinHeight = 58;
	m_sInnateRace.m_nMaxHeight = 70;
	m_sInnateRace.m_nMinWeight = 90;
	m_sInnateRace.m_nMaxWeight = 240;
	...
	m_sInnateRace.m_pnSaves[CAttributes::SAVE_SPELL] = -15;
	m_sInnateRace.m_pnSaves[CAttributes::SAVE_POISON] = 0;
	PopulateInnateString(m_strInnates);
}

void CHalfDrowElfReference::SetStrength()
{
...
void CHalfDrowElfReference::SetDexterity()
{
...
void CHalfDrowElfReference::SetAgility()
{
