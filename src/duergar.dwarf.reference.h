...
/*
*
*	DuergarDwarfReference
*
*
*/

#ifndef _DUERGAR_REFERENCES_H_
#define _DUERGAR_REFERENCES_H_

#include "racial.reference.h"

class CDuergarDwarfReference : public CRacialReference
{
private:
	CString m_strInnates;
public:
	virtual CString GetInnates()  const {return m_strInnates;}
	CDuergarDwarfReference();
	...
	virtual ~CDuergarDwarfReference();
};
#endif
