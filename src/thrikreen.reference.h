...
#ifndef _THRIKREEN_REFERENCES_H_
#define _THRIKREEN_REFERENCES_H_

#include "racial.reference.h"

class CThriKreenReference : public CRacialReference
{
private:
...
public:
	...
	virtual ~CThriKreenReference();
	virtual void SetRacialSkills(const short int *pSkills) const{;}
};
#endif
