...
CNPCEmpath::CNPCEmpath(CMobPrototype &mob,CRoom *pPutInRoom)
	:CEmpath(mob,pPutInRoom), CNPC(mob,pPutInRoom),CCharacter(mob,pPutInRoom)
{
...
////////////////////////////
short CNPCEmpath::GetMaxHitPointsPerLevel()
{
