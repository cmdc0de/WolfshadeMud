...
/*
*
*	MountainDwarfReference
*
*
*/

#ifndef _MOUNTAIN_REFERENCES_H_
#define _MOUNTAIN_REFERENCES_H_

#include "racial.reference.h"

class CMountainDwarfReference : public CRacialReference
{
private:
	CString m_strInnates;
public:
	virtual CString GetInnates() const {return m_strInnates;}
	CMountainDwarfReference();
	...
	virtual ~CMountainDwarfReference();
};
#endif
