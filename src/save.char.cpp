...
sSaveChar::sSaveChar(CCharacterAttributes *pCharSave, short nSaveState)
{
	...
	strncpy(m_strLongDescription,pCharSave->m_strLongDescription,(pCharSave->m_strLongDescription.GetLength()>MAX_LONG_STR ? MAX_LONG_STR : pCharSave->m_strLongDescription.GetLength()));
	m_strLongDescription[MAX_LONG_STR-1] = '\0';
	strncpy(m_strDescription,pCharSave->m_strDescription,(pCharSave->m_strDescription.GetLength()>MAX_STR ? MAX_STR : pCharSave->m_strDescription.GetLength()));
	m_strDescription[MAX_STR-1] = '\0';
	strncpy(m_strName,pCharSave->m_strName,(pCharSave->m_strName.GetLength()>MAX_NAME_SIZE ? MAX_NAME_SIZE : pCharSave->m_strName.GetLength()));
	m_strName[MAX_NAME_SIZE-1] = '\0';
	strncpy(m_strPassword,pCharSave->m_strPassword,(pCharSave->m_strPassword.GetLength()>MAX_PASSWORD ? MAX_PASSWORD : pCharSave->m_strPassword.GetLength()));
	m_strPassword[MAX_PASSWORD-1] = '\0';
	strncpy(m_strPoofIn,pCharSave->m_strPoofIn,(pCharSave->m_strPoofIn.GetLength()>MAX_STR ? MAX_STR : pCharSave->m_strPoofIn.GetLength()));
	m_strPoofIn[MAX_STR-1] = '\0';
	strncpy(m_strPoofOut,pCharSave->m_strPoofOut,(pCharSave->m_strPoofOut.GetLength()>MAX_STR ? MAX_STR : pCharSave->m_strPoofOut.GetLength()));
	m_strPoofOut[MAX_STR-1] = '\0';
	strncpy(m_strTitle,pCharSave->m_strTitle,(pCharSave->m_strTitle.GetLength()>MAX_STR ? MAX_STR : pCharSave->m_strTitle.GetLength()));
	m_strTitle[MAX_STR-1] = '\0';
	strncpy(m_strGuildName,pCharSave->m_strGuildName,(pCharSave->m_strGuildName.GetLength()>MAX_STR ? MAX_STR : pCharSave->m_strGuildName.GetLength()));
