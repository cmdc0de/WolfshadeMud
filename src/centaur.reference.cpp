...
CCentaurReference::~CCentaurReference()
{
	//do nothing
}

CCentaurReference::CCentaurReference() : CRacialReference()
{
	SetAll();
	m_nSize = SIZE_LARGE;
	...
	m_nWearPositions [8]= WEAR_POS_ON_BACK;
	m_nWearPositions [9] = WEAR_POS_ARMS;
	m_nWearPositions [10]= WEAR_POS_WRIST;
	m_nWearPositions [11]= WEAR_POS_WRIST;
	m_nWearPositions [12]= WEAR_POS_RING;
	m_nWearPositions [13]= WEAR_POS_RING;
	m_nWearPositions [14]= WEAR_POS_HANDS;
	m_nWearPositions [15] = WEAR_POS_WIELD | WEAR_POS_HOLD | WEAR_POS_WIELD_TWO_HANDED;
	m_nWearPositions [16]= WEAR_POS_SHIELD | WEAR_POS_HOLD | WEAR_POS_DUAL_WIELD;
	m_nWearPositions [17]= WEAR_POS_TAIL;
	m_nWearPositions [18]= WEAR_POS_LEGS;
	m_nWearPositions [19]= WEAR_POS_LEGS;
	m_nWearPositions [20]= WEAR_POS_FEET;
	m_nWearPositions [21]= WEAR_POS_FEET;//22
	CalcTotalWeaponPositions();
}

void CCentaurReference::SetCharisma()
{
	...
	m_sCharisma[10] = sCharisma(10,10,10); //100-109
	m_sCharisma[11] = sCharisma(20,20,20); //110-119
	m_sCharisma[12] = sCharisma(22,22,22); //120
}

void CCentaurReference::SetIntellegence()
{
	...
	m_sIntellegence[9] = sIntellegence(10,-1,1); //90-99
	m_sIntellegence[10] = sIntellegence(20,-2,2); //100-109
	m_sIntellegence[11] = sIntellegence(30,-3,3); //110-119
	m_sIntellegence[12] = sIntellegence(33,-4,4); //120
}

void CCentaurReference::SetWisdom()
{
	...
	m_sWisdom[12] = sWisdom(33,-4,5); //120
}

void CCentaurReference::SetPower()
{
	...
	m_sPower[12] = sPower(35,0); //120
}

void CCentaurReference::SetConstitution()
{
...
void CCentaurReference::SetInnateRace()
{
	...
	m_sInnateRace.m_nMaxWeight = 900;
...
void CCentaurReference::SetStrength()
{
	m_sStrength[0] = sStrength(0,10,0); //0-9
	m_sStrength[1] = sStrength(0,20,0); //10-19
	m_sStrength[2] = sStrength(0,40,0); //20-29
	m_sStrength[3] = sStrength(1,80,0); //30-39
	m_sStrength[4] = sStrength(1,120,0); //40-49
	m_sStrength[5] = sStrength(1,160,0); //50-59
	m_sStrength[6] = sStrength(1,200,0); //60-69
	m_sStrength[7] = sStrength(2,250,0); //70-79
...
void CCentaurReference::SetDexterity()
{
	...
	m_sDexterity[10] = sDexterity(10,10,30,30); //90-99
	m_sDexterity[11] = sDexterity(10,10,30,30); //110-119
	m_sDexterity[12] = sDexterity(15,15,40,40); //120
}

void CCentaurReference::SetAgility()
{
