...
CTrollReference::~CTrollReference() {
   //do nothing
}

CTrollReference::CTrollReference() : CRacialReference() {
   SetAll();
   m_nSize = SIZE_LARGE;
...
void CTrollReference::SetCharisma() {
...
void CTrollReference::SetIntellegence() {
...
void CTrollReference::SetWisdom() {
...
void CTrollReference::SetConstitution() {
...
void CTrollReference::SetInnateRace() {
   m_sInnateRace.m_nInnate_ablities = INNATE_ULTRAVISION |
	   INNATE_DAY_SIGHT | INNATE_REGENERATE;
...
void CTrollReference::SetStrength() {
...
void CTrollReference::SetDexterity() {
...
void CTrollReference::SetAgility() {
