...
CElementalReference::~CElementalReference()
{
	//do nothing
}

CElementalReference::CElementalReference() : CRacialReference()
{
	SetAll();
	m_nSize = SIZE_MEDIUM;
...
void CElementalReference::SetCharisma()
{
...
void CElementalReference::SetIntellegence()
{
	...
	m_sIntellegence[11] = sIntellegence(20,-2,2); //110-119
	m_sIntellegence[12] = sIntellegence(30,-3,3); //120
}

void CElementalReference::SetWisdom()
{
...
void CElementalReference::SetPower()
{
...
void CElementalReference::SetConstitution()
{
...
void CElementalReference::SetInnateRace()
{
...
void CElementalReference::SetStrength()
{
	m_sStrength[0] = sStrength(0,10,-10); //0-9
	m_sStrength[1] = sStrength(0,10,0); //10-19
	m_sStrength[2] = sStrength(0,10,0); //20-29
	m_sStrength[3] = sStrength(0,10,0); //30-39
	m_sStrength[4] = sStrength(0,10,0); //40-49
	m_sStrength[5] = sStrength(0,10,0); //50-59
	m_sStrength[6] = sStrength(0,10,0); //60-69
	m_sStrength[7] = sStrength(0,10,0); //70-79
	m_sStrength[8] = sStrength(0,10,10); //80-89
	m_sStrength[9] = sStrength(0,20,20); //90-99
	m_sStrength[10] = sStrength(0,30,30); //90-99
	m_sStrength[11] = sStrength(0,30,30); //110-119
	m_sStrength[12] = sStrength(0,35,35); //120
}

void CElementalReference::SetDexterity()
{
...
void CElementalReference::SetAgility()
{
