...
CGithyankiReference::~CGithyankiReference() {
  //do nothing
}

CGithyankiReference::CGithyankiReference() : CRacialReference() {
  SetAll();
  m_nSize = SIZE_MEDIUM;
...
void CGithyankiReference::SetCharisma() {
...
void CGithyankiReference::SetIntellegence() {
...
void CGithyankiReference::SetWisdom() {
...
void CGithyankiReference::SetPower() {
...
void CGithyankiReference::SetConstitution() {
  m_sConstitution[0] = sConstitution(0, 0, -10); //0-9
  ...
  m_sConstitution[7] = sConstitution(2, 3, 0); //70-79
  m_sConstitution[8] = sConstitution(4, 4, 0); //80-89
  m_sConstitution[9] = sConstitution(6, 5, 10); //90-99
  m_sConstitution[10] = sConstitution(8, 6, 20); //100-109
  m_sConstitution[11] = sConstitution(8, 7, 30); //110-119
  m_sConstitution[12] = sConstitution(10, 8, 40); //120
}

void CGithyankiReference::SetInnateRace() {
...
void CGithyankiReference::SetStrength() {
  ...
  m_sStrength[8] = sStrength(2, 150, 10); //80-89
  m_sStrength[9] = sStrength(3, 180, 20); //90-99
  m_sStrength[10] = sStrength(4, 210, 30); //90-99
  m_sStrength[11] = sStrength(5, 280, 30); //110-119
  m_sStrength[12] = sStrength(6, 300, 35); //120
}

void CGithyankiReference::SetDexterity() {
...
void CGithyankiReference::SetAgility() {
  ...
  m_sAgility[8] = sAgility(2, 10, 10, 10, 10); //80-89
  m_sAgility[9] = sAgility(3, 20, 20, 20, 20); //90-99
  m_sAgility[10] = sAgility(4, 30, 30, 30, 30); //100-109
  m_sAgility[11] = sAgility(5, 40, 40, 40, 40); //110-119
  m_sAgility[12] = sAgility(6, 50, 50, 50, 50); //120
}
