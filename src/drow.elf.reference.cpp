...
CDrowElfReference::~CDrowElfReference() {
  //do nothing
}

CDrowElfReference::CDrowElfReference() : CRacialReference() {
  SetAll();
  m_nSize = SIZE_MEDIUM;
...
void CDrowElfReference::SetCharisma() {
...
void CDrowElfReference::SetIntellegence() {
...
void CDrowElfReference::SetWisdom() {
...
void CDrowElfReference::SetPower() {
  ...
  m_sPower[9] = sPower(20, 1); //90-99
  m_sPower[10] = sPower(30, 2); //100-109
  m_sPower[11] = sPower(30, 3); //110-119
  m_sPower[12] = sPower(40, 3); //120
}

void CDrowElfReference::SetConstitution() {
...
void CDrowElfReference::SetInnateRace() {
  m_sInnateRace.m_nInnate_ablities = INNATE_ULTRAVISION |
	  INNATE_DAY_SIGHT | INNATE_FLY | INNATE_FAERIE_FIRE;
  ...
  m_sInnateRace.m_pnSaves[CAttributes::SAVE_SPELL] = -30;
  m_sInnateRace.m_pnSaves[CAttributes::SAVE_POISON] = 0;
  PopulateInnateString(m_strInnates);
}

void CDrowElfReference::SetStrength() {
...
void CDrowElfReference::SetDexterity() {
...
void CDrowElfReference::SetAgility() {
