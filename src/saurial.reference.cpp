...
CSaurialReference::~CSaurialReference() {
   //do nothing
}

CSaurialReference::CSaurialReference() : CRacialReference() {
   SetAll();
   m_nSize = SIZE_MEDIUM;
   ...
   m_nWearPositions [20] = WEAR_POS_TAIL;
   m_nWearPositions [21] = WEAR_POS_LEGS; //22
   CalcTotalWeaponPositions();
}

void CSaurialReference::SetCharisma() {
...
void CSaurialReference::SetIntellegence() {
...
void CSaurialReference::SetWisdom() {
...
void CSaurialReference::SetPower() {
...
void CSaurialReference::SetConstitution() {
...
void CSaurialReference::SetInnateRace() {
...
void CSaurialReference::SetStrength() {
   ...
   m_sStrength[6] = sStrength(1, 130, 0); //60-69
   m_sStrength[7] = sStrength(2, 160, 0); //70-79
   m_sStrength[8] = sStrength(3, 190, 10); //80-89
   m_sStrength[9] = sStrength(4, 230, 20); //90-99
   m_sStrength[10] = sStrength(5, 280, 30); //90-99
   m_sStrength[11] = sStrength(5, 340, 30); //110-119
   m_sStrength[12] = sStrength(6, 400, 35); //120
}

void CSaurialReference::SetDexterity() {
...
void CSaurialReference::SetAgility() {
