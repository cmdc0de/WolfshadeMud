...
COgreReference::~COgreReference() {
   //do nothing
}

COgreReference::COgreReference() : CRacialReference() {
   SetAll();
   m_nSize = SIZE_HUGE;
   m_lStartRoom = OGRE_START_ROOM;
   ...
   m_nWearPositions [18] = WEAR_POS_SHIELD | WEAR_POS_HOLD | WEAR_POS_DUAL_WIELD | WEAR_POS_WIELD_TWO_HANDED;
...
void COgreReference::SetCharisma() {
   m_sCharisma[0] = sCharisma(-20, -20, -20); //0-9
   m_sCharisma[1] = sCharisma(-10, -10, -10); //10-19
   ...
   m_sCharisma[9] = sCharisma(0, 0, 0); //90-99
   m_sCharisma[10] = sCharisma(0, 0, 0); //100-109
   m_sCharisma[11] = sCharisma(10, 10, 10); //110-119
   m_sCharisma[12] = sCharisma(10, 10, 10); //120
}

void COgreReference::SetIntellegence() {
   ...
   m_sIntellegence[9] = sIntellegence(10, 0, 0); //90-99
   m_sIntellegence[10] = sIntellegence(20, 0, 0); //100-109
   m_sIntellegence[11] = sIntellegence(20, -1, 1); //110-119
   m_sIntellegence[12] = sIntellegence(30, -2, 2); //120
}

void COgreReference::SetWisdom() {
...
void COgreReference::SetConstitution() {
   m_sConstitution[0] = sConstitution(0, -2, 0); //0-9
   m_sConstitution[1] = sConstitution(2, -1, 0); //10-19
   m_sConstitution[2] = sConstitution(4, 0, 0); //20-29
   m_sConstitution[3] = sConstitution(6, 0, 10); //30-39
   m_sConstitution[4] = sConstitution(6, 0, 10); //40-49
   m_sConstitution[5] = sConstitution(6, 0, 10); //50-59
   m_sConstitution[6] = sConstitution(6, 0, 10); //60-69
   m_sConstitution[7] = sConstitution(8, 1, 20); //70-79
   m_sConstitution[8] = sConstitution(10, 2, 30); //80-89
   m_sConstitution[9] = sConstitution(12, 3, 40); //90-99
   m_sConstitution[10] = sConstitution(14, 4, 50); //100-109
   m_sConstitution[11] = sConstitution(16, 5, 60); //110-119
   m_sConstitution[12] = sConstitution(18, 6, 72); //120
}

void COgreReference::SetInnateRace() {
...
void COgreReference::SetStrength() {
   m_sStrength[0] = sStrength(0, 20, -10); //0-9
   m_sStrength[1] = sStrength(0, 50, 0); //10-19
   m_sStrength[2] = sStrength(0, 80, 0); //20-29
   m_sStrength[3] = sStrength(1, 110, 0); //30-39
   m_sStrength[4] = sStrength(1, 140, 0); //40-49
   m_sStrength[5] = sStrength(1, 170, 0); //50-59
   m_sStrength[6] = sStrength(1, 200, 0); //60-69
   m_sStrength[7] = sStrength(2, 240, 0); //70-79
   m_sStrength[8] = sStrength(3, 300, 10); //80-89
   m_sStrength[9] = sStrength(4, 350, 20); //90-99
   m_sStrength[10] = sStrength(5, 400, 30); //90-99
   m_sStrength[11] = sStrength(5, 450, 30); //110-119
   m_sStrength[12] = sStrength(6, 500, 35); //120
}

void COgreReference::SetDexterity() {
   m_sDexterity[0] = sDexterity(-20, 0, 0, 0); //0-9
   m_sDexterity[1] = sDexterity(-10, 0, 0, 0); //10-19
   ...
   m_sDexterity[8] = sDexterity(0, 0, 10, 10); //80-89
   m_sDexterity[9] = sDexterity(0, 0, 20, 20); //90-99
   m_sDexterity[10] = sDexterity(0, 0, 30, 30); //90-99
   m_sDexterity[11] = sDexterity(10, 0, 40, 40); //110-119
   m_sDexterity[12] = sDexterity(20, 0, 40, 40); //120
}

void COgreReference::SetAgility() {
   ...
   m_sAgility[11] = sAgility(3, 50, 50, 50, 50); //110-119
   m_sAgility[12] = sAgility(4, 55, 55, 55, 55); //120
}
