...
CBarbarianReference::~CBarbarianReference()
{
	//do nothing
}

CBarbarianReference::CBarbarianReference() : CRacialReference()
{
	SetAll();
	m_nSize = SIZE_LARGE;
	...
	//WEAR_POS_SHIELD should be with dual
...
void CBarbarianReference::SetCharisma()
{
	...
	m_sCharisma[12] = sCharisma(27,27,27); //120
}

void CBarbarianReference::SetIntellegence()
{
	...
	m_sIntellegence[11] = sIntellegence(22,0,2); //110-119
	m_sIntellegence[12] = sIntellegence(25,0,2); //120
}

void CBarbarianReference::SetWisdom()
{
	...
	m_sWisdom[11] = sWisdom(25,-2,2); //110-119
	m_sWisdom[12] = sWisdom(28,-3,3); //120
}

void CBarbarianReference::SetPower()
{
	...
	m_sPower[11] = sPower(33,0); //110-119
	m_sPower[12] = sPower(35,0); //120
}

void CBarbarianReference::SetConstitution()
{
	...
	m_sConstitution[11] = sConstitution(11,5,40); //110-119
	m_sConstitution[12] = sConstitution(12,6,42); //120
}

void CBarbarianReference::SetInnateRace()
{
	m_sInnateRace.m_nInnate_ablities = INNATE_DAY_SIGHT;
...
void CBarbarianReference::SetStrength()
{
	...
	m_sStrength[9] = sStrength(4,260,20); //90-99
	m_sStrength[10] = sStrength(5,320,30); //90-99
	m_sStrength[11] = sStrength(7,400,40); //110-119
	m_sStrength[12] = sStrength(8,500,45); //120
}

void CBarbarianReference::SetDexterity()
{
...
void CBarbarianReference::SetAgility()
{
	...
	m_sAgility[12] = sAgility(5,42,42,42,42); //120
}
