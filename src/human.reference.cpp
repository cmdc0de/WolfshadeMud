...
CHumanReference::~CHumanReference()
{
	//do nothing
}

CHumanReference::CHumanReference() : CRacialReference()
{
	SetAll();
	m_nSize = SIZE_MEDIUM;
...
void CHumanReference::SetCharisma()
{
...
void CHumanReference::SetIntellegence()
{
...
void CHumanReference::SetWisdom()
{
...
void CHumanReference::SetConstitution()
{
...
void CHumanReference::SetInnateRace()
{
...
void CHumanReference::SetStrength()
{
	...
	m_sStrength[4] = sStrength(0,70,0); //40-49
	m_sStrength[5] = sStrength(0,90,0); //50-59
	m_sStrength[6] = sStrength(0,110,0); //60-69
	m_sStrength[7] = sStrength(1,140,0); //70-79
	m_sStrength[8] = sStrength(2,190,5); //80-89
	m_sStrength[9] = sStrength(3,230,15); //90-99
	m_sStrength[10] = sStrength(4,290,25); //90-99
	m_sStrength[11] = sStrength(5,320,30); //110-119
	m_sStrength[12] = sStrength(6,400,35); //120
}

void CHumanReference::SetDexterity()
{
...
void CHumanReference::SetAgility()
{
