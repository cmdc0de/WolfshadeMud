...
CMinotaurReference::~CMinotaurReference()
{
	//do nothing
}

CMinotaurReference::CMinotaurReference() : CRacialReference()
{
	SetAll();
	m_nSize = SIZE_LARGE;
	m_lStartRoom = GEN_NEUTRAL_START_ROOM;
	...
	m_nWearPositions [16] = WEAR_POS_WIELD | WEAR_POS_WIELD_TWO_HANDED | WEAR_POS_HOLD;
...
void CMinotaurReference::SetCharisma()
{
...
void CMinotaurReference::SetIntellegence()
{
...
void CMinotaurReference::SetWisdom()
{
...
void CMinotaurReference::SetPower()
{
...
void CMinotaurReference::SetConstitution()
{
	...
	m_sConstitution[11] = sConstitution(12,5,50); //110-119
	m_sConstitution[12] = sConstitution(14,6,52); //120
}

void CMinotaurReference::SetInnateRace()
{
	m_sInnateRace.m_nInnate_ablities = INNATE_ULTRAVISION |
		INNATE_DAY_SIGHT;
	m_sInnateRace.m_nMinHeight = 92;
	m_sInnateRace.m_nMaxHeight = 120;
	m_sInnateRace.m_nMinWeight = 200;
	m_sInnateRace.m_nMaxWeight = 450;
	m_sInnateRace.m_nMinAge = 18;
	m_sInnateRace.m_nMaxAge = 90;
	m_sInnateRace.m_nStartingAlignment = 0;
	m_sInnateRace.m_nRaceWar = RACE_NEUTRAL;
...
void CMinotaurReference::SetStrength()
{
	...
	m_sStrength[5] = sStrength(1,110,0); //50-59
	m_sStrength[6] = sStrength(1,140,0); //60-69
	m_sStrength[7] = sStrength(2,180,0); //70-79
	m_sStrength[8] = sStrength(3,220,10); //80-89
	m_sStrength[9] = sStrength(4,270,20); //90-99
	m_sStrength[10] = sStrength(5,320,30); //90-99
	m_sStrength[11] = sStrength(5,380,30); //110-119
	m_sStrength[12] = sStrength(6,440,35); //120
}

void CMinotaurReference::SetDexterity()
{
...
void CMinotaurReference::SetAgility()
{
