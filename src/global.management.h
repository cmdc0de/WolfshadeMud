...
public:
	...
	void AddGod(CCharacter *pCh) {m_GodLL.Add(pCh);} //only call these if you are not entering or logging from game
	void RemoveGod(CCharacter *pCh) {m_GodLL.Remove(pCh);}
...
{
	for(register int i = 0;i<TOTAL_RACES;i++)
	{
