...
CNPCRanger::CNPCRanger(CMobPrototype &mob, CRoom *pPutInRoom)
: CRanger(mob, pPutInRoom), CNPC(mob, pPutInRoom), CCharacter(mob, pPutInRoom) {
...
short CNPCRanger::GetMaxHitPointsPerLevel() {
