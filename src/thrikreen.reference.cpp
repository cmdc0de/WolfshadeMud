...
CThriKreenReference::~CThriKreenReference() {
   //do nothing
}

CThriKreenReference::CThriKreenReference() : CRacialReference() {
   SetAll();
   m_nSize = SIZE_MEDIUM;
   m_lStartRoom = THRI_KREEN_START_ROOM;
   ...
   m_nWearPositions [4] = WEAR_POS_ON_BACK;
   m_nWearPositions [5] = WEAR_POS_ARMS;
   m_nWearPositions [6] = WEAR_POS_ARMS;
   m_nWearPositions [7] = WEAR_POS_WRIST;
   m_nWearPositions [8] = WEAR_POS_WRIST;
   m_nWearPositions [9] = WEAR_POS_WRIST;
   m_nWearPositions [10] = WEAR_POS_WRIST;
   m_nWearPositions [11] = WEAR_POS_HANDS;
   m_nWearPositions [12] = WEAR_POS_HANDS;
   m_nWearPositions [13] = WEAR_POS_WIELD | WEAR_POS_HOLD | WEAR_POS_WIELD_TWO_HANDED;
   m_nWearPositions [14] = WEAR_POS_SHIELD | WEAR_POS_HOLD | WEAR_POS_DUAL_WIELD;
   ...
   m_nWearPositions [17] = WEAR_POS_WAIST;
   m_nWearPositions [18] = WEAR_POS_LEGS;
   m_nWearPositions [19] = WEAR_POS_FEET; //20
   CalcTotalWeaponPositions();
}

void CThriKreenReference::SetCharisma() {
...
void CThriKreenReference::SetIntellegence() {
...
void CThriKreenReference::SetWisdom() {
...
void CThriKreenReference::SetPower() {
...
void CThriKreenReference::SetConstitution() {
...
void CThriKreenReference::SetInnateRace() {
...
void CThriKreenReference::SetStrength() {
   m_sStrength[0] = sStrength(0, 10, -10); //0-9
   m_sStrength[1] = sStrength(0, 20, 0); //10-19
   m_sStrength[2] = sStrength(0, 30, 0); //20-29
   m_sStrength[3] = sStrength(1, 40, 0); //30-39
   m_sStrength[4] = sStrength(1, 60, 0); //40-49
   m_sStrength[5] = sStrength(1, 80, 0); //50-59
   m_sStrength[6] = sStrength(1, 100, 0); //60-69
   m_sStrength[7] = sStrength(2, 120, 0); //70-79
   m_sStrength[8] = sStrength(3, 140, 10); //80-89
   m_sStrength[9] = sStrength(4, 170, 20); //90-99
   m_sStrength[10] = sStrength(5, 200, 30); //90-99
   m_sStrength[11] = sStrength(5, 240, 30); //110-119
   m_sStrength[12] = sStrength(6, 300, 35); //120
}

void CThriKreenReference::SetDexterity() {
...
void CThriKreenReference::SetAgility() {
