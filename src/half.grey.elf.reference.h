...
/*
*
*	HalfGreyElfReferences
*
*
*/

#ifndef _HALF_GREY_ELF_REFERENCES_H_
#define _HALF_GREY_ELF_REFERENCES_H_

#include "racial.reference.h"

class CHalfGreyElfReference : public CRacialReference
{
private:
	CString m_strInnates;
public:
	virtual CString GetInnates()  const {return m_strInnates;}
	CHalfGreyElfReference();
