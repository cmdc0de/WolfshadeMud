...
CMulReference::~CMulReference()
{
	//do nothing
}

CMulReference::CMulReference() : CRacialReference()
{
	SetAll();
	m_nSize = SIZE_LARGE;
...
void CMulReference::SetCharisma()
{
...
void CMulReference::SetIntellegence()
{
...
void CMulReference::SetConstitution()
{
...
void CMulReference::SetInnateRace()
{
	m_sInnateRace.m_nInnate_ablities = INNATE_ULTRAVISION |
		INNATE_DAY_SIGHT;
	m_sInnateRace.m_nMinHeight = 80;
	m_sInnateRace.m_nMaxHeight = 110;
	m_sInnateRace.m_nMinWeight = 180;
	m_sInnateRace.m_nMaxWeight = 400;
	m_sInnateRace.m_nMinAge = 40;
	m_sInnateRace.m_nMaxAge = 450;
...
void CMulReference::SetStrength()
{
	...
	m_sStrength[4] = sStrength(1,90,0); //40-49
	m_sStrength[5] = sStrength(1,120,0); //50-59
	m_sStrength[6] = sStrength(1,150,0); //60-69
	m_sStrength[7] = sStrength(2,190,0); //70-79
	m_sStrength[8] = sStrength(3,240,10); //80-89
	m_sStrength[9] = sStrength(4,290,20); //90-99
	m_sStrength[10] = sStrength(5,350,30); //90-99
	m_sStrength[11] = sStrength(5,400,30); //110-119
	m_sStrength[12] = sStrength(6,450,35); //120
}

void CMulReference::SetDexterity()
{
