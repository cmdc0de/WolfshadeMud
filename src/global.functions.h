...
UINT HashKey(char *str,int nLetters)
{
	UINT nHash = 0;
	int ncount = 0;
...
CWolfshadeLog &endl(CWolfshadeLog &log){return log.end();}
CWolfshadeLog &_endl(CWolfshadeLog &log, CString &str) {return log.end(str);}
WSMMANIP endl(CString &str){return WSMMANIP(_endl,&str);}
