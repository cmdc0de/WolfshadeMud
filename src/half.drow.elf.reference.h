...
/*
*
*	HalfDrowElfReferences
*
*
*/

#ifndef _HALF_DROW_ELF_REFERENCES_H_
#define _HALF_DROW_ELF_REFERENCES_H_

#include "racial.reference.h"

class CHalfDrowElfReference : public CRacialReference
{
private:
	CString m_strInnates;
public:
	virtual CString GetInnates()  const {return m_strInnates;}
	CHalfDrowElfReference();
