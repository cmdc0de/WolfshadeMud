...
CNPCAntiPaladin::CNPCAntiPaladin(CMobPrototype &mob, CRoom *pPutInRoom)
	:CAntiPaladin(mob,pPutInRoom),CNPC(mob,pPutInRoom),CCharacter(mob,pPutInRoom)
{
...
CNPCAntiPaladin::~CNPCAntiPaladin()
{
...
////////////////////////////
short CNPCAntiPaladin::GetMaxHitPointsPerLevel()
{
