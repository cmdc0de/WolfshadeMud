...
CDuergarDwarfReference::~CDuergarDwarfReference()
{
	//do nothing
}
...
void CDuergarDwarfReference::SetCharisma()
{
...
void CDuergarDwarfReference::SetIntellegence()
{
	...
	m_sIntellegence[11] = sIntellegence(30,0,3); //110-119
	m_sIntellegence[12] = sIntellegence(40,0,4); //120
}

void CDuergarDwarfReference::SetWisdom()
{
...
void CDuergarDwarfReference::SetConstitution()
{
...
void CDuergarDwarfReference::SetInnateRace()
{
	m_sInnateRace.m_nInnate_ablities = INNATE_ULTRAVISION |
		INNATE_DAY_SIGHT | INNATE_INVIS | INNATE_LARGE | INNATE_STRENGTH;
...
void CDuergarDwarfReference::SetStrength()
{
...
void CDuergarDwarfReference::SetDexterity()
{
...
void CDuergarDwarfReference::SetAgility()
{
