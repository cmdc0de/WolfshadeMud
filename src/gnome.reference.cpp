...
CGnomeReference::~CGnomeReference()
{
	//do nothing
}

CGnomeReference::CGnomeReference() : CRacialReference()
{
	SetAll();
	m_nSize = SIZE_SMALL;
...
void CGnomeReference::SetCharisma()
{
	...
	m_sCharisma[12] = sCharisma(35,35,35); //120
}

void CGnomeReference::SetIntellegence()
{
	...
	m_sIntellegence[12] = sIntellegence(35,-4,4); //120
}

void CGnomeReference::SetWisdom()
{
	...
	m_sWisdom[12] = sWisdom(35,-4,4); //120
}
...
void CGnomeReference::SetConstitution()
{
	m_sConstitution[0] = sConstitution(0,-1,-20); //0-9
	...
	m_sConstitution[7] = sConstitution(0,2,0); //70-79
	m_sConstitution[8] = sConstitution(1,3,0); //80-89
	m_sConstitution[9] = sConstitution(2,4,0); //90-99
	m_sConstitution[10] = sConstitution(4,5,10); //100-109
	m_sConstitution[11] = sConstitution(5,6,10); //110-119
	m_sConstitution[12] = sConstitution(6,7,20); //120
}

void CGnomeReference::SetInnateRace()
{
	m_sInnateRace.m_nInnate_ablities = INNATE_INFRAVISION |
		INNATE_DAY_SIGHT;
	m_sInnateRace.m_nMinHeight = 30;
	m_sInnateRace.m_nMaxHeight = 48;
	m_sInnateRace.m_nMinWeight = 65;
	m_sInnateRace.m_nMaxWeight = 150;
	m_sInnateRace.m_nMinAge = 60;
	m_sInnateRace.m_nMaxAge = 200;
...
void CGnomeReference::SetStrength()
{
	...
	m_sStrength[7] = sStrength(0,110,0); //70-79
	m_sStrength[8] = sStrength(0,130,0); //80-89
	m_sStrength[9] = sStrength(1,160,10); //90-99
	m_sStrength[10] = sStrength(2,190,20); //90-99
	m_sStrength[11] = sStrength(3,240,30); //110-119
	m_sStrength[12] = sStrength(4,300,35); //120
}

void CGnomeReference::SetDexterity()
{
	m_sDexterity[0] = sDexterity(-10,0,-20,-20); //0-9
	...
	m_sDexterity[9] = sDexterity(20,0,10,10); //90-99
	m_sDexterity[10] = sDexterity(30,10,20,20); //90-99
	m_sDexterity[11] = sDexterity(40,20,30,30); //110-119
	m_sDexterity[12] = sDexterity(50,30,40,40); //120
}

void CGnomeReference::SetAgility()
{
