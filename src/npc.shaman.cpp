...
CNPCShaman::CNPCShaman(CMobPrototype &mob, CRoom *pPutInRoom)
: CShaman(mob, pPutInRoom), CNPC(mob, pPutInRoom), CCharacter(mob, pPutInRoom) {
...
short CNPCShaman::GetMaxHitPointsPerLevel() {
