...
COrcReference::~COrcReference() {
   //do nothing
}

COrcReference::COrcReference() : CRacialReference() {
   SetAll();
   m_nSize = SIZE_MEDIUM;
...
void COrcReference::SetCharisma() {
...
void COrcReference::SetIntellegence() {
...
void COrcReference::SetConstitution() {
...
void COrcReference::SetInnateRace() {
   m_sInnateRace.m_nInnate_ablities = INNATE_DAY_SIGHT | INNATE_ULTRAVISION | INNATE_SUMMON_HORDE;
...
void COrcReference::SetStrength() {
   ...
   m_sStrength[4] = sStrength(1, 70, 0); //40-49
   m_sStrength[5] = sStrength(1, 90, 0); //50-59
   m_sStrength[6] = sStrength(1, 110, 0); //60-69
   m_sStrength[7] = sStrength(2, 140, 0); //70-79
   m_sStrength[8] = sStrength(3, 190, 10); //80-89
   m_sStrength[9] = sStrength(4, 230, 20); //90-99
   m_sStrength[10] = sStrength(5, 290, 30); //90-99
   m_sStrength[11] = sStrength(5, 320, 30); //110-119
   m_sStrength[12] = sStrength(6, 400, 35); //120
}

void COrcReference::SetDexterity() {
