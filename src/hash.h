...
UINT HashKey(char *key,int nLetters);
...
protected:
	...
	public:
		...
		VALUE m_value;
		sNode *m_pNext;
		sNode(KEY key,int nLettersToHash) {m_key = key;m_nLettersToHash = nLettersToHash; m_pNext =NULL;}
		bool operator==(long nVal) {return m_key==nVal;}
