...
CNPCDruid::CNPCDruid(CMobPrototype &mob, CRoom *pPutInRoom)
: CDruid(mob, pPutInRoom), CNPC(mob, pPutInRoom), CCharacter(mob, pPutInRoom) {
...
short CNPCDruid::GetMaxHitPointsPerLevel() {
