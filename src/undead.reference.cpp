...
CUndeadReference::~CUndeadReference() {
   //do nothing
}

CUndeadReference::CUndeadReference() : CRacialReference() {
   SetAll();
   m_nSize = SIZE_MEDIUM;
...
void CUndeadReference::SetCharisma() {
...
void CUndeadReference::SetIntellegence() {
...
void CUndeadReference::SetWisdom() {
...
void CUndeadReference::SetPower() {
...
void CUndeadReference::SetConstitution() {
...
void CUndeadReference::SetInnateRace() {
   ...
   m_sInnateRace.m_nMaxWeight = 310;
   m_sInnateRace.m_nMinAge = 1;
   m_sInnateRace.m_nMaxAge = 5;
...
void CUndeadReference::SetStrength() {
   ...
   m_sStrength[9] = sStrength(0, 100, 0); //90-99
   m_sStrength[10] = sStrength(1, 110, 5); //90-99
   m_sStrength[11] = sStrength(2, 120, 10); //110-119
   m_sStrength[12] = sStrength(2, 130, 15); //120
}

void CUndeadReference::SetDexterity() {
...
void CUndeadReference::SetAgility() {
