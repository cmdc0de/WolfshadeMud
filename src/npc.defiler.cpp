...
CNPCDefiler::CNPCDefiler(CMobPrototype &mob, CRoom *pPutInRoom)
	:CDefiler(mob,pPutInRoom),CNPC(mob,pPutInRoom),CCharacter(mob,pPutInRoom)
{
...
////////////////////////////
short CNPCDefiler::GetMaxHitPointsPerLevel()
{
